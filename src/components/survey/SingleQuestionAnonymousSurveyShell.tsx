...
const DEMOGRAPHICS_QUESTIONS: DBDemoQuestion[] = [
  ...
  },
  {
    ...
    inputType: 'dropdown',
    options: [
      'Administration', 'Call Center', 'Commercial Banking',
      'Credit Department', 'Information Systems / Technology',
      'Loan Administration', 'Operations', 'Retail Banking',
  ...
  },
  {
    ...
    inputType: 'dropdown',
    options: [
      'Branch Staff', 'Branch Manager', 'Call Center Operations',
      'C-Suite Executive', 'Credit Underwriting', 'Executive Management',
      'Finance', 'Financial Advisors', 'Human Resources',
      'Loan Administration', 'Operations Staff', 'Relationship Manager',
      'Risk', 'Support Staff', 'Technology Staff', 'Other',
    ],
    allowOther: true,
