...
export const survey = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: "Auto-generated from title. Optional - will be created automatically if not set.",
    }),
    defineField({
      name: "surveyNumber",
      title: "Survey Number",
    ...
    defineField({
      ...
      type: "text",
      rows: 3,
      description: "Instructions shown to respondents before they begin. Can be plain text or rich text.",
    }),
    defineField({
      name: "requiresManagerName",
      title: "Requires Manager Name",
      type: "boolean",
      description: "If true, survey requires entering the name of the manager/associate being evaluated",
      initialValue: false,
    }),
    defineField({
      ...
      type: "boolean",
      description: "If true, individual responses are never shown (Associate 180 only). Requires minimum 5 respondents for reports.",
      initialValue: false,
    }),
    defineField({
      ...
      type: "number",
      description: "Minimum number of respondents required before reports can be generated (typically 5 for anonymous surveys)",
      initialValue: 1,
    }),
    defineField({
      name: "sections",
