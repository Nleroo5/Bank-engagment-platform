      ...
      <div className="hidden md:block">
        ...
        >
          {SCALE_LABELS.map((item) => (
            <label
              key={item.value}
              className={`group relative flex flex-1 cursor-pointer flex-col items-center justify-center rounded-2xl border-2 px-6 py-8 transition-all duration-200 has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary-500 has-[:focus-visible]:ring-offset-2 ${
      ...
      <div className="md:hidden">
        ...
        >
          {SCALE_LABELS.map((item) => (
            <label
              key={item.value}
              className={`group relative flex cursor-pointer items-center gap-4 rounded-2xl border-2 p-6 transition-all duration-200 has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary-500 has-[:focus-visible]:ring-offset-2 ${
                selectedValue === item.value
