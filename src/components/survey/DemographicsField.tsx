      ...
      <div className="hidden md:block">
        ...
        >
          {effectiveOptions.map((item) => (
            <label
              key={item}
              className={`group relative flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 px-6 py-8 transition-all duration-200 has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary-500 has-[:focus-visible]:ring-offset-2 ${
                selectedValue === item
